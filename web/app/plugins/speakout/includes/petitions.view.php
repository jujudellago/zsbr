	...
	<table class="widefat">
		...
		<?php foreach ( $petitions as $petition ) : ?>
			...
			<tr class="dk-speakout-tablerow">
				...
				<td><?php echo '[emailpetition id="' . $petition->id . '"] - display petition<br />[signaturelist id="' . $petition->id . '"] - display signature list<br />[signaturecount id="' . $petition->id . '"] - display signature count<br />[signaturegoal id="' . $petition->id . '"] - display signature goal'; ?></td>
