...
class HTML_Form
{
                        ...
                        $maxlength = 0, $attr = '')
    {
        ...
        $str .= 'size="' . $size . '" value="' . self::sanitize($default) . '" ';
        if ($maxlength) {
    ...
    function returnPassword($name, $default = null,
                            ...
                            $maxlength = 0, $attr = '')
    {
        $str  = '<input type="password" name="' . $name . '" id="' . $name . '" ';
        $str .= 'size="' . $size . '" value="' . self::sanitize($default) . '" ';
        if ($maxlength) {
            $str .= 'maxlength="' . $maxlength. '" ';
        }
    ...
    {
        $str = "<input type=\"checkbox\" name=\"$name\" id=\"' . $name . '\" ";
    ...
    function returnTextarea($name, $default = null, $width = 40, $height = 5,
                            $maxlength = 0, $attr = '')
    {
        $str  = '<textarea name="' . $name . '" id="' . $name . '" cols="' . $width . '"';
        $str .= ' rows="' . $height . '" ';
        if ($maxlength) {
            $str .= 'maxlength="' . $maxlength. '" ';
        }
    ...
    function returnSubmit($title = 'Submit Changes', $name = 'submit',
                          $attr = '')
    {
        return '<input type="submit" id="' . $name . '" name="' . $name . '"'
               . ' value="' . $title . '" ' . $attr . "/>\n";
    }
    ...
    function returnReset($title = 'Clear contents', $attr = '')
    {
        return '<input type="reset"'
               . ' value="' . self::sanitize($title) . '" ' . $attr . "/>\n";
    }
                          ...
                          $blank = '', $multiple = false, $attr = '')
    {
        ...
        foreach ($entries as $val => $text) {
            ...
            $str .= 'value="' . self::sanitize($val) . '">' . $text . "</option>\n";
        }
        $str .= "   </select>\n";
    ...
    {
        return '<input type="radio" id="' . $name . '" name="' . $name . '"' .
    ...
    {
        return '<input type="image" id="' . $name . '" name="' . $name . '"' .
               ' src="' . $src . '" ' . $attr . "/>\n";
    }
    ...
    function returnHidden($name, $value, $attr = '')
    {
        return '<input type="hidden" id="' . $name . '" name="' . $name . '"'
               . ' value="' . self::sanitize($value) . '" ' . $attr . "/>\n";
    }
                        ...
                        $accept = '', $attr = '')
    {
        ...
        $str .= $maxsize . "\" />\n";
        $str .= '   <input type="file" id="' . $name . '" name="' . $name . '"';
        $str .= ' size="' . $size . '" ';
        if ($accept) {
            $str .= 'accept="' . $accept . '" ';
        }
