...
var A=this.mouse.now;if(Browser.Engine.trident){return(A.x>B.left&&A.x<B.right&&A.y<(B.bottom+window.getScroll().y)&&A.y>(B.top+window.getScroll().y));}else{return(A.x>B.left&&A.x<B.right&&A.y<B.bottom&&A.y>B.top);}},checkDroppables:function(){var A=this.droppables.filter(this.checkAgainst,this).getLast();
