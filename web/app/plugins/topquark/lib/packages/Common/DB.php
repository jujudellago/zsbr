...
class DB
{
    ...
    function &connect($dsn, $options = array())
    {
        ...
        if (isset($options['debug']) && $options['debug'] >= 2) {
			...
			// Editted by Top Quark (Trevor Mills) to not @include_once
			// This include can cause some issues and doing @include_once
			// meant that the thing was just silently failing.
            include_once "DB/${type}.php";
        }
