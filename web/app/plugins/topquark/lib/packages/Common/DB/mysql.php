...
// Changed by Top Quark (Trevor Mills) to include dirname to avoid
// an issue on Windows servers where it was including common.php from the PEAR 
// directory, causing blank screen
