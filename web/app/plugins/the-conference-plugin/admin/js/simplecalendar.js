	...
	*/
	...
	Calendar.prototype.buildString = function(){
	  ...
	  */
	  ...
	  tmpStr += '<table border="0" cellspacing="0" cellpadding="0"><tr><td class="cal"><a href="javascript: g_Calendar.changeYear(-1);" class="up"></a></td><td class="cal" width="100%" align="center">' + this.year + '</td><td class="cal"><a href="javascript: g_Calendar.changeYear(+1);" class="down"></a></td></tr></table>'
	  }
	  tmpStr += '</td>';
	  ...
	  if (this.hasDropDown) {
	    ...
	    tmpStr += '<table border="0" cellspacing="0" cellpadding="0"><tr><td><a href="javascript: g_Calendar.changeMonth(-1);" class="up""></a></td><td class="cal" width="100%" align="center">' + this.months[this.month] + '</td><td class="cal"><a href="javascript: g_Calendar.changeMonth(+1);" class="down"></a></td></tr></table>';
	  }
	  tmpStr += '</td>';
	  tmpStr += '</tr>';
	  tmpStr += '</table>';
	...
	Calendar.prototype.show = function(event, target, bHasDropDown, dateFormat, xOffSet, yOffSet, dateFrom, dateTo){
	...
	this.xOffSet = xOffSet || -105;
	this.yOffSet = yOffSet || 20;
	switch (this.dateFormat){
	  ...
	  if (browser.ns4){
	    this.containerLayer.x = event.x + this.xOffSet;
	    this.containerLayer.y = event.y + this.yOffSet;
	  }
	  if (browser.ie5 || browser.ie4){
