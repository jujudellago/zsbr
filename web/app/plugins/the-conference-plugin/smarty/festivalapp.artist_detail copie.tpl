...
<div class="artist-detail">
	...
	{if $Artist->getParameter('ArtistShows') ne ''}
		<div class="simple-info schedule_box">
			<strong><a href="{$SchedulePage}id={$Artist->getParameter('ArtistID')}">{'Artist'|vocabulary} Schedule</a></strong>
	...
	{if $Images ne ""}
		...
		<a href="{$Image.Original}" class="portfolio-item-preview" data-rel="prettyPhoto" title="{$Artist->getParameter('ArtistFullName')}"><img border="0" src="{$Image.$Thumb}"  class="portfolio-img pretty-box speaker_bio"/></a>
	{/if}
